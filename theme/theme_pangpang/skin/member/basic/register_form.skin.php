...
<div class="container">
      ...
      <style>
      .flabel {width:100px;}
      .form_01 {display:flex;justify-content: center; }
      .card-container.card{max-width:650px;padding:30px;}
 ...
 <div id="register_form"  class="form_01">
        ...
        <div class="card card-container shadow">
          <!--필수-->
          <div>
              <h2><strong>필수</strong></h2>
                  <div class="mb-3">
                      <label for="reg_mb_id" class="flabel xxxxxsound_only"><strong>ID</strong></label>
                      <input type="text" name="mb_id" value="<?php echo $member['mb_id'] ?>"
                       id="reg_mb_id" required class="frm_input half_input required" minlength="3" maxlength="20" placeholder="아이디">
                      <span id="msg_mb_id"></span>
                      <!--span class="frm_info">영문자, 숫자, _ 만 입력 가능. 최소 3자이상</span-->
                  </div>
                  <div class="mb-3">
                      <label for="reg_mb_password" class="flabel xxxsound_only">비밀번호</label>
                      <input type="password" name="mb_password" id="reg_mb_password" required
                        class="frm_input half_input required" minlength="3" maxlength="20" placeholder="비밀번호">
                  </div>
                  <div class="mb-3">
                      <label for="reg_mb_password_re" class="flabel xxxxxsound_only">비번 확인</label>
                      <input type="password" name="mb_password_re" id="reg_mb_password_re" required
                        class="frm_input half_input required" minlength="3" maxlength="20" placeholder="비밀번호 확인">
                  </div>
                  <div class="mb-3">
                      <label for="reg_mb_email" class="flabel">이메일</label>
                      ...
                      <input type="text" name="mb_email" value="<?php echo isset($member['mb_email'])?$member['mb_email']:''; ?>"
                       id="reg_mb_email" required class="frm_input email half_input required" size="70" maxlength="100" placeholder="E-mail">
                  </div>
          </div>
          ...
          <div class="tbl_frm01 tbl_wrap">
              <!--<h2>기타 개인설정</h2>-->
              <div>
              <h2><strong>선택</strong></h2>

                  <div class="mb-3">
                      <label for="mb_1" class="flabel xxxxxsound_only">학교(소속)</label>
                      <input type="text" name="mb_1" id="mb_1" placeholder="학교(소속)" value="<?php echo $member['mb_1'] ?>" class="frm_input half_input">
                  </div>
                  <div class="mb-3">
                      <label for="mb_2" class="flabel xxxxxsound_only">학번</label>
                      <input type="text" name="mb_2" id="mb_2" placeholder="학번" value="<?php echo $member['mb_2'] ?>" class="frm_input half_input">
                  </div>
                  <div class="mb-3">
                      <label for="mb_3" class="flabel xxxxxsound_only">그룹코드</label>
                      <input type="text" name="mb_3" id="mb_3" placeholder="그룹코드" value="<?php echo $member['mb_3'] ?>" class="frm_input half_input">
                  </div>
                              <!--
