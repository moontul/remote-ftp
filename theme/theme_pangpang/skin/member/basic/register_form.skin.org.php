 ...
 <div id="register_form"  class="form_01">
    ...
    <div class="tbl_frm01 tbl_wrap" style="margin-top:-20px;">
        ...
        <ul>
            ...
            -->
            <li>
                <label for="reg_mb_email" class="">E-mail<strong>필수</strong></label>
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <ul>
          <li>
              <label for="mb_1" class="sound_only">학교(소속)</label>
              <input type="text" name="mb_1" id="mb_1" placeholder="학교(소속)" value="<?php echo $member['mb_1'] ?>" class="frm_input full_input">
          </li>
          <li>
              <label for="mb_1" class="sound_only">학번</label>
              <input type="text" name="mb_2" id="mb_2" placeholder="학번" value="<?php echo $member['mb_2'] ?>" class="frm_input full_input">
          </li>
