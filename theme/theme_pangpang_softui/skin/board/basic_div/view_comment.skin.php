...
<aside id="bo_vc_w" class="bo_vc_w">
    ...
    <div class="bo_vc_w_wr">
        ...
        <div class="btn_confirm">
            ...
            <label for="wr_secret" class="text-sm"><i class="fa fa-lock" aria-hidden="true"></i><span class="sound_only">비밀글사용</span></label>
            <input type="submit" id="btn_submit" class="btn btn-sm" value="댓글등록">
        </div>
    </div>
    </form>
</aside>
