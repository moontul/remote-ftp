<?php include_once(G5_PATH."/page.wraptop.php");?>
...
?>
	...
	<?php if(1==2){ //xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx?>
...
<?php } //xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx?>


        <div class="container margin-top-40">
            <div class="row" style="overflow: hidden;">
                <div class="col-sm-12 pt-4" style="overflow-y: auto;">

									<div class="ct-docs-page-title">
							      <span class="ct-docs-page-h1-title"><?=$board['bo_subject']?></span>
							    </div>
							    <hr class="ct-docs-hr">
				...
				<section id="bo_w">
					<h4 class="sound_only"><?php echo $g5['title'] ?></h2>
					...
					if ($is_notice || $is_html || $is_secret || $is_mail) {
						$option = '';
						if ($is_notice) {
							$option .= "\n".'<input type="checkbox" id="notice" name="notice" class="" value="1" '.$notice_checked.'>'."\n".'<label for="notice">공지</label>';
						}
					...
					<div class="bo_w_tit write_div">
						...
						<div id="autosave_wrapper write_div">
							<input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="form-control frm_input full_input required"
							size="50" maxlength="255" placeholder="제목">
							<?php if ($is_member) { // 임시 저장된 글 기능 ?>
							<script src="<?php echo G5_JS_URL; ?>/autosave.js"></script>
							<?php if($editor_content_js) echo $editor_content_js; ?>
							<button type="button" id="btn_autosave" class="btn btn-sm pb-0 pt-1 ps-2 pe-2">임시 저장된 글 (<span id="autosave_count"><?php echo $autosave_count; ?></span>)</button>
							<div id="autosave_pop">
					...
					<div class="write_div">
						<!--label for="wr_content" class="sound_only">내용<strong>필수</strong></label    <?php echo $is_dhtml_editor ? $config['cf_editor'] : ''; ?>-->
						<div class="">
					...
					<div class="bo_w_link write_div">
						...
						<input type="text" name="wr_link<?php echo $i ?>" value="<?php if($w=="u"){echo$write['wr_link'.$i];} ?>" id="wr_link<?php echo $i ?>"
						class="form-control frm_input full_input" size="50">
					</div>
					<?php } ?>
					...
					<div class="bo_w_flie write_div">
						<div class="file_wr write_div">
							<label for="bf_file_<?php echo $i+1 ?>" class="lb_icon"><i class="fa fa-download" aria-hidden="true"></i>
					...
					<div class="btn_confirm write_div text-center">
						...
						<input type="submit" value="작성완료" id="btn_submit" accesskey="s" class="btn bg-gradient-primary">
					</div>
					</form>
...
<?php include_once(G5_PATH."/page.wrapbottom.php");?>
