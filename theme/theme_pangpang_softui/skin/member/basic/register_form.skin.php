    ...
    <div class="page-header min-vh-85">
      <div>
        <img class="position-absolute fixed-top ms-auto w-50 h-100 z-index-0 d-none d-sm-none d-md-block border-radius-section border-top-end-radius-0 border-top-start-radius-0 border-bottom-end-radius-0"
         src="<?=G5_THEME_URL?>/assets/img/curved-images/curved8.jpg" alt="image">
      </div>
      <div class="container">
        <div class="row">
          <div class="col-lg-7 d-flex justify-content-center flex-column">
            <div class="card d-flex blur justify-content-center p-4 shadow-lg my-sm-0 my-sm-6 mt-8 mb-5">
              <div class="text-center">
                ...
                <p class="mb-0">
                  <?php if($w==''){?>
                  팡팡은 최소한의 정보로 회원 가입합니다. <br>
                  이메일은 비밀번호 분실 시 사용됩니다.
                <?php }else{?>
                  바꾸고 싶은 정보를 입력하고 정보수정 버튼을 누르세요.<br>
                ...
                <div class="card-body pb-2">
                  ...
                  <div class="form-group mb-0 mt-md-0 mt-4">
                    <label class="fw-bolder">필수사항</label>
                  </div>

                  <div class="row">
                    <div class="col-md-6">
                      <div class="input-group mb-1">
                        <input  type="text" name="mb_id" value="<?php echo $member['mb_id'] ?>" id="reg_mb_id"  minlength="3"
                          class="form-control required" required placeholder="아이디" aria-label="아이디"
                          <?php echo $w==''?'':'readonly'; ?> >
                        <!--span class="frm_info">영문자, 숫자, _ 만 입력 가능. 최소 3자이상</span-->
                      </div>
                    </div>
                    <div class="col-md-6"><span id="msg_mb_id"></span>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="input-group mb-1">
                        <input  type="password" name="mb_password" id="reg_mb_password" minlength="3" maxlength="20" required class="form-control" placeholder="비밀번호" aria-label="아이디">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="input-group">
                        <input type="password" name="mb_password_re" id="reg_mb_password_re" minlength="3" maxlength="20" required class="form-control" placeholder="비밀번호 확인">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="input-group mb-1">
                        <input  type="text" name="mb_email" value="<?php echo isset($member['mb_email'])?$member['mb_email']:''; ?>"
                         id="reg_mb_email" required maxlength="100" class="form-control" placeholder="이메일" aria-label="이메일">

                        <?php if ($config['cf_use_email_certify']) { ///////////////// 이메일 인증을 이용할 경우 사용하는 코드 ?>
                        <span class="frm_info">
                    ...
                    <div class="col-md-6"><input type="hidden" name="old_email" value="<?php echo $member['mb_email'] ?>"></div>
                  </div>


                  <div class="form-group mb-0 mt-md-0 mt-4 pt-1">
                    <label class="fw-bolder">선택사항</label>
                  </div>

                  <div class="row">
                    <div class="col-md-6">
                      <div class="input-group mb-1">
                        <input type="text" name="mb_1" id="mb_1" value="<?php echo $member['mb_1'] ?>" class="form-control" placeholder="학교 또는 소속">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="input-group mb-1">
                        <input type="text" name="mb_2" id="mb_2" value="<?php echo $member['mb_2'] ?>" class="form-control" placeholder="학번">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="input-group mb-1">
                        <input type="text" name="mb_3" id="mb_3" value="<?php echo $member['mb_3'] ?>" class="form-control" placeholder="그룹코드">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-12 d-flex">
                      ...
                      <button type="submit" id="btn_submit" class="btn bg-gradient-primary mt-3 mb-0"><?php echo $w==''?'회원가입':'정보수정'; ?></button>

                      <a href="/" class="btn bg-gradient-white mt-3 mb-0">초기화면</a>
                      <?php if($w!=''){?>
                      <a href="javascript:member_leave();" class="ms-auto end-0 btn bg-gradient-secondary mt-3 mb-0 btn_cancel">회원탈퇴</a>
                      <?php } ?>
          ...
          <div class="tbl_frm01 tbl_wrap">
              ...
              <div>
                            ...
                            -->
                                  ...
                                  <?php }  ?>
                                  <!---li class="is_captcha_use">자동등록방지<xxxxxphp echo captcha_html(); ?></li----->

              </div>


            <!--
          <div class="xxxxxbtn_confirm" style="text-align:center;">
              <a href="<?php echo G5_URL ?>" class="btn btn-light shadow-sm">취소</a>
              <input type="submit" value="<?php echo $w==''?'회원가입':'정보수정'; ?>" id="btn_submit"
              class="btn btn-pp-outline-pink" accesskey="s">
              <?php if($is_member){?>
                <a href="<?php echo G5_BBS_URL ?>/member_confirm.php?url=member_leave.php">탈퇴하기</a>
              <?php } ?>
          </div>
        -->
