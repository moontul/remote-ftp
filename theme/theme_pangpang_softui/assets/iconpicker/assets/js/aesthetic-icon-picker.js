var AestheticIconPicker = function(option) {
	...
	var aestheticWrap = '<div class="aim-modal aim-open" id="aim-modal"><div class="aim-modal--content"><div class="aim-modal--header"><div class="aim-modal--header-logo-area"><span class="aim-modal--header-logo-title">아이콘 선택</span></div><div class="aim-modal--header-close-btn"><i class="fas fa-times" title="Close"></i></div></div><div class="aim-modal--body"><div id="aim-modal--sidebar" class="aim-modal--sidebar"><div class="aim-modal--sidebar-tabs"></div></div><div id="aim-modal--icon-preview-wrap" class="aim-modal--icon-preview-wrap"><div class="aim-modal--icon-search"><input name="" value="" placeholder="Filter by name..."><i class="fas fa-search"></i></div><div class="aim-modal--icon-preview-inner"><div id="aim-modal--icon-preview"></div></div></div></div><div class="aim-modal--footer"><button type="button" class="aim-insert-icon-button">아이콘 넣기</button></div></div></div>';
	...
	document.querySelector(defaultOpt.onClick).addEventListener('click', function (e) {
		...
		aestheticDomEle.querySelector('.aim-insert-icon-button').addEventListener('click', function (e) {
			...
			if (null !== selected) {
				...
				document.querySelector('#titleicon').value = sellectedClass;
	...
	document.querySelector('.icon-none').addEventListener('click', function (e) {
		...
		document.querySelector('#titleicon').value = '';
	});
