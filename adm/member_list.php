...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" rowspan="2" id="mb_list_cert"><?php echo subject_sort_link('mb_1', '', 'desc') ?>학교</a></th>
        <th scope="col" rowspan="2" id="mb_list_cert"><?php echo subject_sort_link('mb_2', '', 'desc') ?>학번</a></th>
        <th scope="col" rowspan="2" id="mb_list_cert"><?php echo subject_sort_link('mb_3', '', 'desc') ?>그룹코드</a></th>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td headers="mb_list_1" class="td_col1" rowspan=2>
          <?=$row["mb_1"]?>
        </td>
        <td headers="mb_list_2" class="td_col2" rowspan=2>
          <?=$row["mb_2"]?>
        </td>
        <td headers="mb_list_3" class="td_col3" rowspan=2>
          <?=$row["mb_3"]?>
        </td>
