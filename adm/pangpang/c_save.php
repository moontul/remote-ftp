...
*/
$unitcode=addslashes(trim($_POST["unitcode"]));
$title=addslashes(trim($_POST["title"]));
$content=addslashes(trim($_POST["content"]));
$youtube=addslashes(trim($_POST["youtube"]));

$sql_common = " unitcode     = '$unitcode',
                title    = '$title',
                content    = '$content',
                youtube   = '$youtube' ";
echo($sql_common."<br>");
...
if ($w == "" || $w == "u")
{
  /*
    ...
    */
    goto_url("./c_edit.php?w=u&amp;unitcode=$unitcode");

}
else
{
    goto_url("./c_edit.php?unitcode=$unitcode");
}
