...
<!-------------------------- 네비게이션 -------------------------->
<div class="container-fluid fixed-header top-line">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<div id="tnb_index">
					...
					<!--
						...
						<li><a href="<?php echo G5_URL?>/bbs/current_connect.php" class="visit"><i class="fa fa-users" aria-hidden="true"></i>
							<span>접속자?</span><strong class="visit-num">1</strong></a></li>
...
<nav class="navbar fixed-top navbar-expand-lg navbar-white bg-white fixed-top">
  <div class="container">
	<a class="navbar-brand" href="<?php echo G5_URL?>">
		PANG PANG <!--img src="<?php echo G5_THEME_URL?>/img/logo.png"-->
	</a>

	<button class="navbar-toggler navbar-light bg-light navbar-toggler-right" type="button" data-toggle="collapse"
	...
	<div class="collapse navbar-collapse" id="navbarResponsive" data-hover="dropdown" data-animations="fadeIn fadeIn fadeInUp fadeInRight">
	  <ul class="navbar-nav ml-auto">
		...
		?>
			<?php if($row['sub']['0']) { ?>
				<li class="nav-item dropdown megamenu-li">
					<a class="nav-link dropdown-toggle f16" href="<?php echo $row['me_link']; ?>"
						id="navbarDropdownBlog" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" target="_<?php echo $row['me_target']; ?>">
		...
		<li class="nav-item dropdown login">
		  <a class="nav-link dropdown-toggle f16" href="#" id="navbarDropdownBlog" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				<?php if($is_member) { ?>
		...
		-->
			<?php if($is_member) { ?>
			<a class="dropdown-item" href="<?php echo G5_URL?>/myq">오답노트</a>
			...
			<a class="dropdown-item" href="<?php echo G5_URL?>/bbs/login">로그인</a>
			<a class="dropdown-item" href="<?php echo G5_URL?>/bbs/register">회원가입</a>
