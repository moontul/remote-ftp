...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        <th scope="row"><label for="co_himg">상단이미지<br>(jpg 파일만 사용해주세요)</label></th>
        <td>
            <input type="file" name="co_himg" id="co_himg">
            <?php
            $himg = G5_DATA_PATH.'/content/'.$co['co_id'].'_h.jpg';
            $himg_str = '';
            if (file_exists($himg)) {
                ...
                $himg_str = '<img src="'.G5_DATA_URL.'/content/'.$co['co_id'].'_h.jpg" width="'.$width.'" alt="">';
            }
            if ($himg_str) {
    ...
    <tr>
        <th scope="row"><label for="co_timg">하단이미지<br>(jpg 파일만 사용해주세요)</label></th>
        <td>
            <input type="file" name="co_timg" id="co_timg">
            <?php
            $timg = G5_DATA_PATH.'/content/'.$co['co_id'].'_t.jpg';
            $timg_str = '';
            if (file_exists($timg)) {
                ...
                $timg_str = '<img src="'.G5_DATA_URL.'/content/'.$co['co_id'].'_t.jpg" width="'.$width.'" alt="">';
            }
            if ($timg_str) {
                echo '<div class="banner_or_img">';
                echo $timg_str;
