...
{
    @unlink(G5_DATA_PATH."/content/{$co_id}_h.jpg");
    @unlink(G5_DATA_PATH."/content/{$co_id}_t.jpg");
...
if ($w == "" || $w == "u")
{
    ...
    {
        $dest_path = G5_DATA_PATH."/content/".$co_id."_h.jpg";
        @move_uploaded_file($_FILES['co_himg']['tmp_name'], $dest_path);
        @chmod($dest_path, G5_FILE_PERMISSION);
    }
    if ($_FILES['co_timg']['name'])
    {
        $dest_path = G5_DATA_PATH."/content/".$co_id."_t.jpg";
