...
if(substr($code,0,2)=="SJ"){$sub_menu="000300";}
if(substr($code,0,2)=="LC"){$sub_menu="000400";}
if(substr($code,0,2)=="BK"){$sub_menu="000500";}

$g5['title'] = $code_name . " 단원목록";
        ...
        <th nowrap width=10% style="text-align:center;">단원추가</th>
				...
				<tfoot>
					<?php for($i=0;$i<=2;$i++){ ?>
									...
									<th nowrap><input type="text" name="new_unitname_a[]" size=90 autocomplete="off"></th>
...
<?php } ?>
      ...
      <div class="btn_fixed_top">
          <a href="./code_view.php?code=<?=$code?>" class="btn btn_02">목록</a>
