...
var Editor = /*#__PURE__*/function () {
  function Editor(context) {
    ...
    var commands = ['pp_bold', 'pp_italic', 'pp_underline', 'pp_strikethrough', 'pp_superscript', 'pp_subscript'
		, 'bold', 'italic', 'underline', 'strikethrough', 'superscript', 'subscript'
		, 'justifyLeft', 'justifyCenter', 'justifyRight', 'justifyFull', 'formatBlock', 'removeFormat', 'backColor'];
      ...
      this.context.memo('button.strikethrough', function () {
        return _this2.button({
          ...
          click: _this2.context.createInvokeHandlerAndUpdateState('editor.strikethrough')
			...
			this.context.memo('button.pp_superscript', function () {
        return _this2.button({
          className: 'note-btn-pp_superscript',
          contents: _this2.ui.icon(_this2.options.icons.superscript),
          tooltip: _this2.lang.font.superscript,
          click: _this2.context.createInvokeHandlerAndUpdateState('editor.superscript')
        }).render();
      });
      this.context.memo('button.pp_subscript', function () {
        return _this2.button({
      ...
      this.context.memo('button.ol', function () {
        return _this2.button({
          ...
          click: _this2.context.createInvokeHandler('editor.insertOrderedList')
			...
			var pp_bold = this.button({
        contents: this.ui.icon(this.options.icons.bold),
        tooltip: this.lang.paragraph.right + this.representShortcut('bold'),
        click: this.context.createInvokeHandler('editor.bold')
      });
			var pp_italic = this.button({
        contents: this.ui.icon(this.options.icons.italic),
        tooltip: this.lang.paragraph.right + this.representShortcut('italic'),
        click: this.context.createInvokeHandler('editor.italic')
      });
			var pp_underline = this.button({
        contents: this.ui.icon(this.options.icons.underline),
        tooltip: this.lang.paragraph.right + this.representShortcut('underline'),
        click: this.context.createInvokeHandler('editor.underline')
      });
			var pp_strikethrough = this.button({
        contents: this.ui.icon(this.options.icons.strikethrough),
        tooltip: this.lang.paragraph.right + this.representShortcut('strikethrough'),
        click: this.context.createInvokeHandler('editor.strikethrough')
      });
      ...
      this.context.memo('button.paragraph', function () {
        return _this2.ui.buttonGroup([_this2.button({
          ...
          children: [outdent, indent]
			...
			this.context.memo('button.pp_font', function () {
        return _this2.ui.buttonGroup([_this2.button({
          className: 'dropdown-toggle',
          contents: _this2.ui.dropdownButtonContents(_this2.ui.icon(_this2.options.icons.bold), _this2.options),
          tooltip: _this2.lang.bold,
          data: {
            toggle: 'dropdown'
          }
        }), _this2.ui.dropdown([_this2.ui.buttonGroup({
          className: 'note-align',
          children: [pp_bold, pp_italic, pp_underline]
        }), _this2.ui.buttonGroup({
          className: 'note-list',
          children: [pp_strikethrough]  //, pp_superscript, pp_subscript
        })])]).render();
      });
