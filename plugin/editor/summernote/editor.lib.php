...
?>
<link rel="stylesheet" href="<?php echo $editor_url ?>/summernote/summernote-bs5.css">
<style>
  .note-editable {background-color:#fff;}
</style>

<script src="<?php echo $editor_url ?>/summernote/summernote-bs5.js"></script>
<script src="<?php echo $editor_url ?>/summernote/lang/summernote-ko-KR.js"></script>
<script src="<?php echo $editor_url ?>/summernote/plugin/codewrapper/summernote-ext-codewrapper.js"></script>
<script src="<?php echo $editor_url ?>/summernote/plugin/codewrapper/summernote-ext-highlight.js"></script>
