...
<div class="container-fluid bg-dark">
  <div class="container d-flex">
    ...
    <div class="container w-75" id="container_lowpoly"></div>

    <div class="w-25 top-50 end-0" id="lowpoly_text" style="height:500px; padding-top:200px;"></div>
  ...
  <div class="d-none" id="svgtext_0">
    <!--
    <h2>강좌문제풀이</h2>
    <hr>
    <div>강좌도 보고 문제도 풀고</div>
  -->
  </div>
  <svg id="flamengo" viewBox="0 0 210.64 217.48" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <div id="svgtext_2" class="d-none"><!--
    <h2>도서 문제풀이</h2>
    <hr>
    <div>온라인 ebook 문제풀기</div>-->
  </div>
  <svg id="flower" viewBox="0 0 227.49 200.03">
  ...
  <div id="svgtext_3" class="d-none"></div>

    <svg id="batman"  viewBox="0 0 227.49 200.03">
  ...
  var flowerPolygons = document.querySelector('#flower').querySelectorAll('polygon');

  var batmanPolygons = document.querySelector('#batman').querySelectorAll('polygon');
  var all = [flamengoPolygons, passerinePolygons, flowerPolygons];

  var container = document.querySelector('#container_lowpoly');
  var shapeshifter = new Shapeshifter(container, 0, 0, all[0], {
    /*transformSpeed: {x:0.05, y:0.05},
    hideSpeed: {x:0.05, y:0.05},
    opacitySpeed: 0.05,
    colorSpeed: 0.05,*/
    defaultSpeed: 0.13, //any speed properities not defined will resort to defaultSpeed
    scale: 0.6, //1 makes the initial SVG 100% of the container's width
    center: true,
    strokeOnly: false
  });
...
$(function(){
  ...
  function showPoly(){
    ...
    console.log( $("#lowpoly_text").html( $("#svgtext_"+animationState).html() )   );
  }
  $("#container_lowpoly").click(function(){
    showPoly();
  });
