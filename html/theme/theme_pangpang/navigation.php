...
<nav class="navbar fixed-top navbar-expand-lg navbar-white bg-white fixed-top">
  <div class="container">
	<a class="navbar-brand" href="<?php echo G5_URL?>" class="logo">
		...
		<i class="fab fa-product-hunt fa-spin" style="color:#ff00ff;"></i>ang<i class="fab fa-product-hunt" style="color:#ff00ff;"></i>ang<!--img src="<?php echo G5_THEME_URL?>/img/logo.png"--></a>
	  ...
	  <ul class="navbar-nav ml-auto">
		...
		<li class="nav-item dropdown login">
		  ...
		  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownBlog">
			...
			<?php if($is_member) { ?>
			<a class="dropdown-item" href="<?php echo G5_URL ?>/mychk">오답노트</a>
